                    ...
                    <div class="row-fluid">
                        ...
                        <div id="block_bg" class="block">
                            <div class="navbar navbar-inner block-header">
                                <div class="muted pull-left">Dữ liệu tổng quan</div>
                            </div>
                            <div class="block-content collapse in">
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Giáo viên đăng ký dạy</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Tổng số giáo viên</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Sinh viên đăng ký học</strong>
                                ...
                                <div class="span3">
                                    <div class="chart" data-percent="<?php echo $count_student ?>"><?php echo $count_student ?></div>
                                    <div class="chart-bottom-heading"><strong>Tổng sô sinh viên</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Lớp</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Tổng số file được tải</strong>
                                ...
                                <div class="span3">
                                    ...
                                    <div class="chart-bottom-heading"><strong>Tổng số môn học</strong>
